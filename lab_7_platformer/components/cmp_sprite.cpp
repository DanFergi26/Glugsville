...
void SpriteComponent::update(double dt) {
  ...
  _sprite->setRotation(_parent->getRotation()); // Directly pass the rotation in degrees
}
...
void ShapeComponent::update(double dt) {
  ...
  _shape->setRotation(_parent->getRotation()); // Directly pass the rotation in degrees
}
